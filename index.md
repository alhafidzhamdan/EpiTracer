...
EpiTracer provides a **detection tool and two rearrangement plotters**
for whole-genome sequencing (WGS) data — click a tool for its full
documentation:

| Tool | Purpose |
|:---|:---|
| [**`call_episomal_ecdna()`**](https://alhafidzhamdan.github.io/EpiTracer/docs/call_episomal_ecdna.md) | An episomal ecDNA caller — flags ecDNA amplicons likely generated by simple episomal exclusion. |
| [**`plot_sv_linear()`**](https://alhafidzhamdan.github.io/EpiTracer/docs/plot_sv_linear.md) | A general-purpose, flexible plotter for structural variants and copy number, with an optional stacked SNV panel. |
...
> **AmpliconArchitect is now optional**: pass `ecdna_gr = NULL` and
...
> so it can run from SV + CN alone. Accurate copy-number-segmented SV
> calls remain important for reliably nominating amplicons formed via
> simple episomal exclusion events.
...
Very early development (`v0.0.0.9000`) — everything in this repository
may change.
